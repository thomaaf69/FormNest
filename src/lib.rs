...
#[derive(Debug)]
pub struct FormNestProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FormNestProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FormNest processing");
    
    let mut processor = FormNestProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FormNestProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FormNestProcessor::new(false);
